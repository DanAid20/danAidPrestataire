...
class PrestationEnCours extends StatefulWidget {
  ...
  PrestationEnCours({Key? key, this.userId, this.isbeneficiare, this.data})
      : super(key: key);
...
class _PrestationEnCoursState extends State<PrestationEnCours> {
  ...
  Widget build(BuildContext context) {
    ...
    Stream<QuerySnapshot> query = widget.isbeneficiare == false
        ? FirebaseFirestore.instance
            .collectionGroup('PRESTATIONS')
            .where("adherentId", isEqualTo: widget.userId)
            .where('prestataireId', isEqualTo: prestatiaireObject!.id)
            .snapshots()
        : FirebaseFirestore.instance
            .collectionGroup('PRESTATIONS')
              ...
              child: Column(
                children: [
                  Text(
                    ...
                    style: TextStyle(
                        color: kDateTextColor,
                        fontSize: Device.isSmartphone(context) ? wv * 4 : 15,
                          ...
                          if (snapshot.hasError) {
                            ...
                            return ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  UseCaseServiceModel service =
                                      UseCaseServiceModel.fromDocument(
                                          doc, doc.data() as Map);
                                  return HomePageComponents().prestataireItemList(
                                      ...
                                      iconesConsultationTypes:
                                          Algorithms.getUseCaseServiceIcon(
                                              type: service.type!),
                                              redirectOncliked: () {
                                        Navigator.push(
                                            context,
