                ...
                Positioned(
                  ...
                  child: Stack(children: [
                    CircleAvatar(
                      ...
                      radius: Device.isSmartphone(context) ? wv*18 : 110,
                      child: imageFileAvatar == null ? Icon(LineIcons.user, color: Colors.white, size: Device.isSmartphone(context) ? wv*25 : 140,) : Container(),
                  ...
                  children: [
                    Form(
                      ...
                      child: Column(children: [
                        SizedBox(height: Device.isSmartphone(context) ? hv*3 : 50,),
                        ...
                        SizedBox(height: Device.isSmartphone(context) ? hv*1.5 : 25,),
                        CustomTextField(
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text(S.of(context).genre, style: TextStyle(fontSize: Device.isSmartphone(context) ? wv*4 : 17, fontWeight: FontWeight.w400),),
                                  SizedBox(height: 5,),
                                  Container(
                            ...
                            Expanded(
                              child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text(S.of(context).dateDeNaissance, style: TextStyle(fontSize: Device.isSmartphone(context) ? wv*4 : 17, fontWeight: FontWeight.w400),),
                                  SizedBox(height: 5,),
                                  GestureDetector(
                                    ...
                                    child: Container(
                                      ...
                                      child: Row(children: [
                                        ...
                                        VerticalDivider(),
                                        Text( selectedDate != null ? "${selectedDate!.toLocal()}".split(' ')[0] : "Choisir", style: TextStyle(fontSize: Device.isSmartphone(context) ? wv*4 : 17, color: kPrimaryColor, fontWeight: FontWeight.bold),),
                                      ],),
                                    ),
                                  ),
                                ],
                        ...
                        Row(
                          children: [
                            ...
                            Expanded(
                              child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text(S.of(context).region, style: TextStyle(fontSize: Device.isSmartphone(context) ? wv*4 : 17, fontWeight: FontWeight.w400),),
                                  SizedBox(height: 5,),
                                  Container(
                                    constraints: BoxConstraints(minWidth: wv*45),
                                    padding: EdgeInsets.symmetric(horizontal: 15),
                            ...
                            regionChosen ? Expanded(
                              child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text(S.of(context).choixDeLaVille, style: TextStyle(fontSize: Device.isSmartphone(context) ? wv*4 : 17, fontWeight: FontWeight.w400),),
                                  SizedBox(height: 5,),
                                  Container(
                                    constraints: BoxConstraints(minWidth: wv*45),
                                    padding: EdgeInsets.symmetric(horizontal: 15),
                    ...
                    Padding(
                      padding: EdgeInsets.symmetric(horizontal: Device.isSmartphone(context) ? 0 : 35),
                      child: HomePageComponents.termsAndConditionsTile(
                    ...
                    !buttonLoading ? CustomTextButton(
                      ...
                      action: () async {
                        ...
                        if (_adherentFormKey.currentState!.validate()){
                          ...
                          print("${userProvider.getCountryCode!.toString()} ${FirebaseAuth.instance.currentUser.toString()} ${selectedDate!}");
                          avatarUrl != null ? adherentProvider.setImgUrl(avatarUrl!) : print("tehee");
                          ...
                          await FirebaseFirestore.instance.collection("USERS")
                            ...
                            .set({
                              ...
                              "userCountryCodeIso": userProvider.getCountryCode == null ? null : userProvider.getCountryCode!.toLowerCase(),
                            ...
                            .then((value) async {
                              await FirebaseFirestore.instance.collection("ADHERENTS")
                                ...
                                .then((value) async {
                                  print("local account setting");
                                  print("${plan!.planNumber!} ${userProvider.getUserId!} $_gender!");
                                  ...
                                  avatarUrl == null ? print("Tehee") : HiveDatabase.setImgUrl(avatarUrl!);
          ...
          child: Wrap(
            children: <Widget>[
              ListTile(
                  ...
                  title: Text(S.of(context).gallerie),
                  onTap: () {
                    getImageFromGallery();
