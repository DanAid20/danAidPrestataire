  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text("Edition du Post", style: TextStyle(color: kDeepTeal, fontSize: 17),),
      ...
      body: Column(
        children: [
          ...
          Column(
            ...
            children: [
              Text("   Remplacer", style: TextStyle(color: kDeepTeal, fontSize: 20)),
              SizedBox(height: hv*1,),
              Row(
                children: [
                  SizedBox(width: wv*3,),
                ...
                action: () async {
                  ...
                  if (imageFileAvatar != null) {
                    ...
                    storageUploadTask.whenComplete(() async {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Post Modifié")));
