    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(crossAxisAlignment: CrossAxisAlignment.center,
          children: [
            Text("Détail Consultation", style: TextStyle(color: kPrimaryColor, fontSize: Device.isSmartphone(context) ? wv*4.2 : 22, fontWeight: FontWeight.w400), overflow: TextOverflow.fade,),
            Text("Ajouter, modifier ou envoyer des pièces",  style: TextStyle(color: kPrimaryColor, fontSize: Device.isSmartphone(context) ? wv*3.8 : 17, fontWeight: FontWeight.w300),
            ),
          ],
        ),
        centerTitle: true,
        ...
        child: SizedBox(
          ...
          child: Column(
            children: [
              ...
              Container(
                margin: EdgeInsets.symmetric(horizontal: Device.isSmartphone(context) ? wv*5 : 0, vertical: hv*1),
                child: Row(
                  children: [
                    Hero(child: SvgPicture.asset(Algorithms.getUseCaseServiceIcon(type: widget.type), color: kDeepTeal, width: Device.isSmartphone(context) ? 25 : 40,), tag: widget.type!,),
                  ...
                  child: Column(
                    children: [
                                        ...
                                        GestureDetector(
                                          ...
                                          child: Container(
                                            ...
                                            child: Row(children: [
                                              ...
                                              VerticalDivider(),
                                              Text( selectedDate != null ? "${selectedDate!.toLocal()}".split(' ')[0] : S.of(context).choisir, style: TextStyle(fontSize: Device.isSmartphone(context) ? wv*4 : 16, color: kPrimaryColor, fontWeight: FontWeight.bold),),
                                            ],),
                                          ),
                                        ),
                                      ],
                      ...
                      widget.service != null ? Padding(
                        padding: EdgeInsets.symmetric(horizontal: Device.isSmartphone(context) ? wv*5 : 0, vertical: hv*1),
                        child: Column(
                          children: [
                            SizedBox(height: hv*2,),
                            Row(
                            ...
                            Stack(
                              children: [
                                Container(
                                  padding: EdgeInsets.symmetric(horizontal: Device.isSmartphone(context) ? wv*3 : 20, vertical: hv*1.75),
                                  decoration: BoxDecoration(
                                ...
                                Container(
                                  width: Device.isSmartphone(context) ? wv*60 : 700,
                                  decoration: BoxDecoration(
                                    color: whiteColor,
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      Container(
                                        padding: EdgeInsets.symmetric(horizontal: Device.isSmartphone(context) ? wv*3 : 20, vertical: hv*1),
                                        child: Column(
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: [
                                            Row(children: [
                                  ...
                                  Center(
                                    child: InkWell(
                                      ...
                                      child: Container(
                                        ...
                                        child: SvgPicture.asset('assets/icons/Bulk/Scan.svg', width: Device.isSmartphone(context) ? wv*20 : 170,),
                                      ),
                                    ),
                                  ),
                                  FileUploadCard(
