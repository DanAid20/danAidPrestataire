...
class _AppointmentState extends State<Appointment> {
  ...
  Widget build(BuildContext context) {
    ...
    double defFont = Device.isSmartphone(context) ? wv*4 : 16;
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Column(crossAxisAlignment: CrossAxisAlignment.center,
            children: [
              Text(S.of(context).dmandeDePriseEnCharge, style: TextStyle(color: kPrimaryColor, fontSize: Device.isSmartphone(context) ? wv*4.2 : 22, fontWeight: FontWeight.w400), overflow: TextOverflow.fade,),
              Text(S.of(context).rendezvous, style: TextStyle(color: kPrimaryColor, fontSize: Device.isSmartphone(context) ? wv*3.8 : 20, fontWeight: FontWeight.w300),),
            ],
          ),
          centerTitle: true,
          actions: [
        ...
        child: SizedBox(
          ...
          child: Container(
            ...
            child: Column(
              children: [
                Row(children: [
                  SizedBox(width: Device.isSmartphone(context) ? wv*4 : 30,),
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      children: [
                              ...
                              Row(
                                children: [
                                    ...
                                    child: Container(
                                      ...
                                      child: Padding(
                                        ...
                                        child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                                          children: [
                                            Text(S.of(context).pourLePatient, style: TextStyle(color: kTextBlue, fontSize: Device.isSmartphone(context) ? wv*4 : 17, fontWeight: FontWeight.w900)),
                                            ...
                                            Row(children: [
                                              CircleAvatar(
                                                ...
                                                radius: Device.isSmartphone(context) ? wv*6 : 40,
                                              ...
                                              Expanded(
                                                child: RichText(text: TextSpan(
                                                  ...
                                                  children: [
                                                    TextSpan(text: (DateTime.now().year - appointment.getAppointment!.birthDate!.toDate().year).toString() + " ans", style: TextStyle(fontSize:Device.isSmartphone(context) ? wv*3.3 : 15)),
                                                  ], style: TextStyle(color: kBlueDeep, fontSize: Device.isSmartphone(context) ? wv*4.2 : 17)),
                                                  maxLines: 4,
                                  ...
                                  GestureDetector(
                                    ...
                                    child: Container(
                                      padding: EdgeInsets.all(Device.isSmartphone(context) ? wv*1.5 : 7),
                                      decoration: BoxDecoration(
                                        color: kGoldDeep.withOpacity(0.5),
                                        borderRadius: BorderRadius.circular(10)
                                      ),
                                      child: SvgPicture.asset('assets/icons/Bulk/Edit.svg', color: kGoldDeep, width: Device.isSmartphone(context) ? 20 : 25,),
                                    ),
                                  ),

                                  SizedBox(width: Device.isSmartphone(context) ? wv*5 : 30),
                                ],
                              ),
                              SizedBox(height: hv*2.5,),
                              Text(S.of(context).rendezvousChez, style: TextStyle(color: kTextBlue, fontSize: Device.isSmartphone(context) ? wv*4 : 17, fontWeight: FontWeight.w900)),
                        ...
                        Container(
                          padding: EdgeInsets.symmetric(horizontal: Device.isSmartphone(context) ? wv*4 : 40, vertical: hv*2.5),
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text(S.of(context).raison, style: TextStyle(color: kTextBlue, fontSize: defFont, fontWeight: FontWeight.w400)),
                              Container(
                                width: double.infinity,
                                margin: EdgeInsets.symmetric(vertical: hv*0.5),
                                padding: EdgeInsets.symmetric(horizontal: defFont, vertical: hv*1.5),
                                decoration: BoxDecoration(
                                  color: Colors.grey[100],
                                  borderRadius: BorderRadius.circular(20)
                                ),
                                child: Text(reason, style: TextStyle(color: kTextBlue, fontSize: defFont, fontWeight: FontWeight.w900)),
                              ),

                              Padding(
                                padding: EdgeInsets.symmetric(vertical: hv*2),
                                child: Text(S.of(context).symptmes, style: TextStyle(color: kTextBlue, fontSize: defFont, fontWeight: FontWeight.w400)),
                              ),
                ...
                :
                Container(
                  padding: EdgeInsets.symmetric(horizontal: Device.isSmartphone(context) ? wv*4 : 40),
                  child: CustomTextButton(
                    text: "Sauvegarder",
