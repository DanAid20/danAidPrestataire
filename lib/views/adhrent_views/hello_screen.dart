      ...
      child: Scaffold(
        body: NestedScrollView(floatHeaderSlivers: true, 
            ...
            return <Widget>[
              SliverAppBar(
                ...
                bottom: TabBar(
                  ...
                  tabs: userProvider.getProfileType == doctor ? tabsDoctor : tabs
                ),
              )
            ];
          }, 
          ...
          body: TabBarView(
            controller: _tabController,
            children: <Widget>[
              userProvider.getProfileType == doctor ? ProfilDoctorView() : MyWelcomeScreen(),
              userProvider.getProfileType == doctor ? ProfilDoctorView() : MyCoverageTabView(),
              userProvider.getProfileType == doctor ? ProfilDoctorView() : MyDoctorTabView()
            ],)
