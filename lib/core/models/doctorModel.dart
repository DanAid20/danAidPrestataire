...
class DoctorModel {
  String id, officeCategory, officeName, familyName, surname, about, orderRegistrationCertificate, address, cniName, hospitalTown, field, speciality, email, personContactName, personContactPhone, gender, town, region, profile, medicalService, avatarUrl, cniUrl, orderRegistrationCertificateUrl;
  bool profileEnabled;
  List adherentList;
  ...
  DoctorModel({this.id, this.adherentList, this.rate, this.officeCategory, this.about, this.address, this.officeName, this.familyName, this.surname, this.dateCreated, this.availability, this.serviceList, this.orderRegistrationCertificate, this.cniName, this.hospitalTown, this.field, this.speciality, this.email, this.personContactName, this.personContactPhone, this.gender, this.town, this.region, this.profile, this.medicalService, this.avatarUrl, this.cniUrl, this.orderRegistrationCertificateUrl, this.profileEnabled, this.phoneList, this.location});
