...
class AdherentModel {
  String adherentId, authId, familyDoctorId, cniName, bloodGroup, otherDocName, marriageCertificateName, familyName, surname, couponCodeUsed, matricule, imgUrl, gender, email, profession, regionOfOrigin, marriageCertificateUrl, otherJustificativeDocsUrl, officialDocUrl, town, profileType, address;
  ...
  factory AdherentModel.fromDocument(DocumentSnapshot doc) {
    return AdherentModel(
        ...
        loanLimit: doc.data()["creditLimit"],
        ...
        validityStartDate: doc.data()["datDebutvalidite"],
